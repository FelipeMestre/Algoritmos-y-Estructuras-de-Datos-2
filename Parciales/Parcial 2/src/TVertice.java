...
public class TVertice<T> implements IVertice {
    ...
    /**
     * Realizacion de una bea, para recuperar el camino se coloca a cada vertice del mismo su antecesor directo
     * @param destino Etiqueta destino. cuando se llegue a ella se termina la busqueda
     */
    public void menorEscala(Comparable destino){
        ...
        while (!cola.isEmpty()) {
            ...
            for (TAdyacencia y : (LinkedList<TAdyacencia>) x.getAdyacentes()) {
                if (!y.getDestino().getVisitado()) {
                    ...
                    y.getDestino().setPredecesor(x);
                    if (y.getDestino().getEtiqueta().equals(destino)) {
                        return;
                    }
